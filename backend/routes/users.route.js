...
const { getUsers, getUsersByRole, updateUserRole } = require('../controllers/users.controller');
...
router.get('/role/:role', [authenticate, checkRole(['admin', 'employee']), authLimiter], getUsersByRole);
