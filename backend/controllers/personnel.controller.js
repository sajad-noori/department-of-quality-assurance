  ...
  try {
    ...
    const validatePersonnelData = (data) => {
      const fields = [
        ...
        "technical_master",
        "technical_bachelor",
        "technical_above_baccalaureate",
        "technical_baccalaureate",
        "technical_elementary",
        "admin_phd",
        "admin_master",
        "admin_bachelor",
        "admin_above_baccalaureate",
        "admin_baccalaureate",
        "admin_elementary",
        "service_bachelor",
        "service_above_baccalaureate",
        "service_baccalaureate",
        "service_elementary",
      ];
    ...
    const [existing] = await promise.execute(
      "SELECT * FROM personnel WHERE user_id = ?",
      [req.user.id]
    );
