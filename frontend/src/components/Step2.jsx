...
const Step2 = () => {
  ...
  if (loading) {
  ...
  } else if (stageStatus && stageStatus.stage1) {
    content = (
      <div style={{
        background: '#23272f',
        borderRadius: 16,
        ...
        <div>
          <h2 style={{ margin: 0, fontWeight: 700, fontSize: 28 }}>مرحله دوم</h2>
          <p style={{ margin: '12px 0 0', fontSize: 18 }}>شما مجاز به ادامه مرحله دوم هستید. این یک پیام ساده برای مرحله دوم است.</p>
        </div>
      </div>
    );
  } else {
    content = (
      <div style={{
        ...
        <div>
          <h2 style={{ margin: 0, fontWeight: 700, fontSize: 28 }}>تکمیل مرحله اول الزامی است</h2>
          <p style={{ margin: '12px 0 0', fontSize: 18 }}>برای ادامه باید ابتدا مرحله اول را تکمیل کنید.</p>
        </div>
      </div>
    );
  }
