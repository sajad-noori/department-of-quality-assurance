...
const DocumentsPage = () => {
  ...
  return (
    <div className="dark-container" dir="rtl">
      <div className="container-fluid px-3 px-md-4 px-lg-5">
        {/* Header Section */}
        <div className="row justify-content-center mb-4">
          <div className="col-12 col-lg-10 col-xl-8">
            <div className="text-center mb-4">
              <h2 className="mb-2 dark-text responsive-title">
                <i className="fas fa-folder-open me-2 text-info"></i>
                {categoryTranslations[type] || type}
              </h2>
              <p className="text-light mb-0 responsive-subtitle">
            ...
            <div className="card dark-card">
              <div className="card-body">
                <div className="input-group">
                  <span className="input-group-text dark-input-group">
        ...
        {error && (
          <div className="row justify-content-center">
            <div className="col-12 col-lg-8">
              <div className="alert alert-danger d-flex align-items-center dark-alert text-center" role="alert">
        ...
        {!loading && !error && filteredDocs.length === 0 && (
          <div className="row justify-content-center">
            <div className="col-12 col-lg-8 text-center py-5">
              ...
              <h4 className="text-light responsive-title">هیچ سندی یافت نشد</h4>
          ...
          <div className="row g-3">
            {filteredDocs.map((doc) => (
              <div key={doc.id} className="col-12 col-sm-6 col-lg-4 col-xl-3">
                <div className="card h-100 dark-card hover-shadow">
      ...
      {/* CSS for dark theme, responsive design and skeleton loading */}
      <style>{`
        .dark-container {
          background: #121212;
          min-height: 100vh;
