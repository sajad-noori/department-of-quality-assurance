  ...
  return (
    <div className="container mt-4 p-4 rounded shadow-sm" style={{ maxWidth: '700px' }}>
      <label htmlFor="description" className="form-label small d-block mb-2">
         در این بخش تمامی امکانات اساسی و اولیه مورد نیاز از قبیل ساختمان، صنوف، ورکشاپ، لابراتوار، فارم تحقیقاتی و لیلیه را با جزئیات که در جدول ذیل ذکر گردیده لیست نمائید.
          </label>
