...
const NumberOfStudents = ({ onStepSubmit }) => {
  ...
  const handleAddEntry = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        // Call onStepSubmit when form is successfully submitted
        if (onStepSubmit) {
          onStepSubmit();
        }
      }
  ...
  return (
    <div className="students-form" dir="rtl">
        ...
        <div className="form-section">
          ...
          <div className="form-grid">
            ...
            <div className="form-group">
              <label className="form-label">
                <span className="field-icon">📈</span>
                تعداد جدید شمولان <span className="required">*</span>
              </label>
              <div className="input-wrapper">
                <input
                  type="number"
            ...
            <div className="form-group">
              <label className="form-label">
                <span className="field-icon">👨‍🎓</span>
                تعداد مجموعی شاگرد <span className="required">*</span>
              </label>
              <div className="input-wrapper">
                <input
                  type="number"
            ...
            <div className="form-group">
              <label className="form-label">
                <span className="field-icon">🎯</span>
                تعداد دوره فراغت <span className="required">*</span>
              </label>
              <div className="input-wrapper">
                <input
                  type="number"
                  ...
                  onBlur={handleBlur}
                  className={`form-input ${formErrors.graduationCycles ? 'error' : ''} ${focusedField === 'graduationCycles' ? 'focused' : ''}`}
                  min="0"
                />
                <div className="input-border"></div>
              </div>
              {formErrors.graduationCycles && <div className="error-message">{formErrors.graduationCycles}</div>}
            </div>

            <div className="form-group">
              <label className="form-label">
                <span className="field-icon">📅</span>
                سال تاسیس رشته <span className="required">*</span>
              </label>
              <div className="input-wrapper">
                <input
                  type="number"
                  ...
                  onBlur={handleBlur}
                  className={`form-input ${formErrors.establishmentYear ? 'error' : ''} ${focusedField === 'establishmentYear' ? 'focused' : ''}`}
                  min="1300" max="1500"
                />
                <div className="input-border"></div>
              </div>
              {formErrors.establishmentYear && <div className="error-message">{formErrors.establishmentYear}</div>}
            </div>
          </div>
